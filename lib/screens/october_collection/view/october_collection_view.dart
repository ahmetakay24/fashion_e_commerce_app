...
class OctoberCollectionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    OctoberCollectionTextsEnglish octoberCollectionTextsEnglish = OctoberCollectionTextsEnglish();
    OctoberCollectionImages octoberCollectionImages = OctoberCollectionImages();
      ...
      body: ListView(
        children: [
          Padding(
            ...
            child: OctoberCollection1(
                octoberCollectionImages: octoberCollectionImages,
                textsEnglish: octoberCollectionTextsEnglish,
                size: size,
                colors: colors),
          ),
          OctoberCollection2(
